...
def getSquareRoot():
    ...
    label3 = tk.Label(root, text='You will die at the age of ' + dth, font=('helvetica', 10))
    canvas1.create_window(325, 260, window=label3)


button1 = tk.Button(text='Predict', command=getSquareRoot, bg='brown', fg='white',
